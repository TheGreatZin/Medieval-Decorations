...
/* Bars */
   public static final RegistryObject<WoodenBarsBlock> ACACIA_BARS = registerBlock("acacia_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.ACACIA_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, ACACIA_BARS_ID);
   public static final RegistryObject<WoodenBarsBlock> BIRCH_BARS = registerBlock("birch_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.BIRCH_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, BIRCH_BARS_ID);
   ...
   public static final RegistryObject<WoodenBarsBlock> DARK_OAK_BARS = registerBlock("dark_oak_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.DARK_OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, DARK_OAK_BARS_ID);
   public static final RegistryObject<WoodenBarsBlock> JUNGLE_BARS = registerBlock("jungle_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.JUNGLE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, JUNGLE_BARS_ID);
   public static final RegistryObject<WoodenBarsBlock> OAK_BARS = registerBlock("oak_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, OAK_BARS_ID);
   public static final RegistryObject<WoodenBarsBlock> SPRUCE_BARS = registerBlock("spruce_bars", () -> new WoodenBarsBlock(BlockBehaviour.Properties.of(Material.WOOD, Blocks.SPRUCE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()), 150, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, SPRUCE_BARS_ID);
   ...
   public static final RegistryObject<WoodenGrateBlock> ACACIA_GRATE = registerBlock("acacia_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.ACACIA_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, ACACIA_GRATE_ID);
   public static final RegistryObject<WoodenGrateBlock> BIRCH_GRATE = registerBlock("birch_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.BIRCH_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, BIRCH_GRATE_ID);
   ...
   public static final RegistryObject<WoodenGrateBlock> DARK_OAK_GRATE = registerBlock("dark_oak_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.DARK_OAK_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, DARK_OAK_GRATE_ID);
   public static final RegistryObject<WoodenGrateBlock> JUNGLE_GRATE = registerBlock("jungle_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.JUNGLE_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, JUNGLE_GRATE_ID);
   public static final RegistryObject<WoodenGrateBlock> OAK_GRATE = registerBlock("oak_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.OAK_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, OAK_GRATE_ID);
   public static final RegistryObject<WoodenGrateBlock> SPRUCE_GRATE = registerBlock("spruce_grate", () -> new WoodenGrateBlock(BlockBehaviour.Properties.copy(BlockInit.SPRUCE_BARS.get())), 160, MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, SPRUCE_GRATE_ID);
...
/* Candles */
   ...
   public static final RegistryObject<LargeCandleBlock> BLACK_LARGE_CANDLE = registerBlock("black_large_candle", () -> new LargeCandleBlock(BlockBehaviour.Properties.of(Material.DECORATION, MaterialColor.COLOR_BLACK).noOcclusion().strength(0.2F).sound(SoundType.CANDLE).lightLevel(LargeCandleBlock.LIGHT_EMISSION)), MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, BLACK_LARGE_CANDLE_ID); //121
...
/* Vases */
   ...
   public static final RegistryObject<GlassVaseCandleholderBlock> MOSAIC_STAINED_GLASS_VASE_CANDLEHOLDER = registerBlock("mosaic_stained_glass_vase_candleholder", () -> new GlassVaseCandleholderBlock(BlockBehaviour.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS).noOcclusion()), MedievalDecorations.MEDIEVAL_DECORATIONS_TAB, MOSAIC_STAINED_GLASS_VASE_CANDLEHOLDER_ID);
	...
	private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<? extends T> block, int burnTime, CreativeModeTab tab, String id) {
		RegistryObject<T> toReturn = BLOCKS.register(name, block);
